...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/ansible-core-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12868&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ansible-core-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ansible-core` can be installed with:

```
conda install ansible-core
```

It is possible to list all of the versions of `ansible-core` available on your platform with:
